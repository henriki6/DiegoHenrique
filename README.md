 Diego Henrique
> Estudante de Gestão da Tecnologia da Informação | Foco em Segurança da Informação
...
### 👨‍💻 Sobre
Atualmente cursando **Gestão da Tecnologia da Informação** na **Universidade Cruzeiro do Sul (UNICID)**. Sou apaixonado por resolver problemas através da tecnologia e possuo foco em **Segurança da Informação**.

* **Habilidades Técnicas:** Python.
* **Habilidades Socioemocionais:** Trabalho em equipe, disciplina e comprometimento.
* **Interesse:** Segurança da Informação — proteção de dados, análise de vulnerabilidades e boas práticas de cibersegurança.
